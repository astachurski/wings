...
save_state(St0, St1) ->
    ...
    wings_menu:repeat_cmd(repeat, command_name(?__(1,"Repeat"), St)),
    wings_menu:repeat_cmd(repeat_args, command_name(?__(2,"Repeat Args"), St)),
    wings_menu:repeat_cmd(repeat_drag, command_name(?__(3,"Repeat Drag"), St)),
